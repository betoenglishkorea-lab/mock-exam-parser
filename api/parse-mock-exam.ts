...
- 밑줄 친 단어/구/문장 → [밑줄 친 내용]
- 예시: "밑줄 친 'make a difference'의 의미" → passage에서 해당 부분을 [make a difference]로 표시
- 예시: 지문에 밑줄 친 "The irony is that..."가 있으면 → [The irony is that...]로 변환
- (a), (b) 등의 밑줄도 동일: 밑줄 친 (a) → [(a)]

### 빈칸 처리
- 빈칸 밑줄 → ________ (언더스코어 8개, 원본 길이와 무관하게 통일)
