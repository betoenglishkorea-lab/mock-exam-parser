...
5. 기호 + 밑줄 표현: 기호 뒤에 밑줄 친 단어, 구, 또는 문장
   - 소문자 괄호: (a), (b), (c), (d), (e)
   - 원문자: ①, ②, ③, ④, ⑤
   - 변환 예시:
     - (a)He → [(a)He]
...
2. **연계 지시사항**: 공통 지시사항이 있으면 각 문제의 question_text 앞에 삽입
   - 예: "다음 글을 읽고, 물음에 답하시오."가 공통이면 각 문제에 포함

3. **연계 지문**: 모든 해당 문제의 passage 필드에 동일한 전체 지문 복사
   - ❌ 43번에만 지문, 44·45번은 빈칸 → 틀림
   - ✅ 43, 44, 45번 모두 동일한 지문 전체 입력 → 정답

### 예시 (43~45번 장문독해)

문제 43:
- question_text: "다음 글을 읽고, 물음에 답하시오.\\n\\n위 글 (A)에 이어질 내용을 순서에 맞게 배열한 것으로 가장 적절한 것은?"
...
문제 45:
- question_text: "다음 글을 읽고, 물음에 답하시오.\\n\\n위 글의 Victoria에 관한 내용으로 적절하지 않은 것은?"
- passage: "(A) A fourteen-year-old girl named Victoria... (전체 지문 동일하게 복사)"
